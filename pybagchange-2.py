...
img = cv2.imread(r'D:/Users/Public/Documents/intern/100%pythonCode/Sourcecode/code/train/train/15.jpg', 0)
...
img = cv2.imread(r'D:/Users/Public/Documents/intern/100%pythonCode/Sourcecode/code/train/train/1.jpg')
...
img = cv2.imread(r'D:/Users/Public/Documents/intern/100%pythonCode/Sourcecode/code/train/train/1.jpg', 0)
...
title = tk.Label(text="CLICK BELOW TO CHOOSE PICTURE FOR TESTING DISEASE....", background="yellow", fg="Green",
                 font=("Algerian", 20))
title.grid()

img = ImageTk.PhotoImage(Image.open("org.jpg"))
imglabel = tk.Label(image=img).grid(row=1, column=0)
title = tk.Label(text="HEALTHY LEAF", background="white", fg="green", font=("", 15))
title.grid()'''
...
win_width = 1200  # You can change this to your desired width
win_height = 800  # You can change this to your desired height

root.geometry(f"{win_width}x{win_height}")

# Open the image file
image = Image.open("agri1edit.jpg")
# Resize the image to fit the window
image = image.resize((win_width, win_height), Image.LANCZOS)
# Convert the image into a PhotoImage
background_image = ImageTk.PhotoImage(image)
background_label = tk.Label(root, image=background_image)
background_label.place(relwidth=1, relheight=1)
title_label = tk.Label(root, text="Click Below for selecting the leaf image", font=('Algerian', 20, 'bold'), fg='green')
title_label.grid(row=0, column=0, padx=40, pady=20, sticky='nw')  # This places the title at the top left

# Displaying the "HEALTHY LEAF" image
img = ImageTk.PhotoImage(Image.open("org.jpg"))
imglabel = tk.Label(root, image=img)
imglabel.grid(row=1, column=0, padx=250, sticky='w')  # This places the image slightly to the left

title_label = tk.Label(root, text="HEALTHY LEAF", fg="green", font=("Algerian", 15))
title_label.grid(row=2, column=0, padx=290, sticky='w')

# Configure the columns to adjust their sizes and positions
root.grid_columnconfigure(0, weight=1)  # This gives a weight to the first column, allowing it to expand and occupy more space
root.grid_columnconfigure(1, weight=4)  # This gives a smaller weight to the second column
...
def lateDescription():
    ...
    top.geometry("1500x310")
    top.configure(background="lightblue")
    title = tk.Label(top, text="DESCRIPTION OF LATEBLIGHT \n \n \n \n", background="lightblue", fg="red",
                     font=("Algerian", 20))
    uname = tk.Label(top,
                     text="Plant pathogenic bacteria cause many different kinds of symptoms that include galls and overgrowths, \n wilts, leaf spots, specks and blights, soft rots,\n as well as scabs and cankers. In contrast to viruses,",
                     background="lightblue", fg="Black", font=("High Tower Text", 15)).place(x=30, y=50)
    title.pack()
    #uname.pack()
    top.mainloop()
...
def lateSymptoms():
    ...
    uname = tk.Label(top,
                     ...
                     background="lightgreen", fg="black", font=("High Tower Text", 15)).place(x=30, y=50)
    title.pack()
    #uname.pack()
    top.mainloop()
...
def lateDeficiencies():
    ...
    title = tk.Label(top, text="DEFICIENCIES OF LATEBLIGHT \n \n \n \n", background="green", fg="black",
                     font=("Algerian", 19))
    uname = tk.Label(top,text=" Late blight is a disease caused by a fungus-like microorganism that infects and  kills tomato and potato plants. \nThe pathogen, Phytophthora infestans was responsible for the Irish potato famine of the 1840's.",
                     background="green", fg="black", font=("High Tower Text", 15),anchor="w")
...
def lateFavourable():
    ...
    uname = tk.Label(top,
                     ...
                     background="gray", fg="Black", font=("High Tower Text", 15),anchor="w")
    uname.place(x=30,y=50)
    title.place(x=10,y=50)
    title.pack()
#    uname.pack()
...
def latebl():
    ...
    remedies1 = tk.Label(text=rem1, background="pink",
                         fg="Black", font=("High Tower Text", 12))
    remedies1.grid(column=0, row=8, padx=10, pady=10)
...
def openphoto():
    ...
    fileName = askopenfilename(
        initialdir=r'D:/Users/Public/Documents/intern/100%pythonCode/Sourcecode/code/test/test',
        title='Select image for analysis ',
        filetypes=[('image files', '.jpg')])
    dst = r"D:/Users/Public/Documents/intern/100%pythonCode/Sourcecode/code/testpicture"
